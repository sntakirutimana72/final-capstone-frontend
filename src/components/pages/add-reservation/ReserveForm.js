        ...
        <div className="bg-white rounded-md shadow-md p-5 h-fit md:w-1/3 w-full">
          <form className="w-full " onSubmit={hundleSubmit}>
              ...
              <div className="w-full px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  <select
                    ...
                    className="block appearance-none w-full border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="grid-state"
                  >
                    ...
                    {data.map((room) => (
                      <option
                        value={room.id}
                        key={room.id}
                        selected={location.state == room.id}
                      >
                        {room.name}
                      </option>
                    ))}
            ...
            <div className="mt-5">
              <button
                type="submit"
                className="focus:ring-2 focus:ring-offset-2 text-sm font-semibold leading-none text-white focus:outline-none bg-[#99d461] border rounded hover:bg-[#77b141] py-4 w-full"
              >
                Reserve Room
              </button>
            </div>
